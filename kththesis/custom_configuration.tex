...
\supervisorAsLastname{Moreno}
\supervisorAsFirstname{Rodrigo}
\supervisorAsEmail{sa@kth.se}
% If the supervisor is from within KTH add their KTHID, School and Department info
\supervisorAsKTHID{u100003}
\supervisorAsSchool{\schoolAcronym{CBH}}
\supervisorAsDepartment{Medical Engineering}
...
\examinersLastname{Wang}
\examinersFirstname{Chunliang}
...
\subjectArea{Medical Engineering}
